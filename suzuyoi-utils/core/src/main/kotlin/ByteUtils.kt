 ...
 */
fun Int.toByteArray(littleEndian: Boolean = true) =
  ByteArray(4).also { a ->
 ...
 */
fun ByteArray.toInt(byteOrder: ByteOrder = ByteOrder.LITTLE_ENDIAN) = ByteBuffer.wrap(this).order(byteOrder).int
 ...
 * @param byteOrder convert to LE or BE
 */
fun ByteArray.toUInt(byteOrder: ByteOrder = ByteOrder.LITTLE_ENDIAN) = toInt(byteOrder).toUInt()
 ...
 * @param littleEndian convert to LE or BE
 */
fun Long.toByteArray(littleEndian: Boolean = true) =
  ByteArray(8).also { a ->
 ...
 * @param byteOrder convert to LE or BE
 */
fun ByteArray.toLong(byteOrder: ByteOrder = ByteOrder.LITTLE_ENDIAN) = ByteBuffer.wrap(this).order(byteOrder).long
 ...
 * @param byteOrder convert to LE or BE
 */
fun ByteArray.toULong(byteOrder: ByteOrder = ByteOrder.LITTLE_ENDIAN) = toLong(byteOrder).toULong()
