...
fun String.decodeBase64(provider: Base64Provider = Base64Impl.Default): ByteArray = provider.decode(this)

fun String.decodeBase64ToString(provider: Base64Provider = Base64Impl.Default): String = provider.decodeToString(this)

fun ByteArray.encodeBase64(provider: Base64Provider = Base64Impl.Default): String = provider.encode(this)

fun String.encodeBase64(provider: Base64Provider = Base64Impl.Default): String = provider.encode(this)
