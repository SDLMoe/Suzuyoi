...
object RSAProvider {
  ...
  private fun getPublicKey(string: String): PublicKey = keyFactory.generatePublic(X509EncodedKeySpec(base64.decode(string)))

  private fun getPrivateKey(string: String): PrivateKey = keyFactory.generatePrivate(PKCS8EncodedKeySpec(base64.decode(string)))
